    ...
    private static void show(CharSequence text, int duration) {
        ...
        if (!isCustom) {
            if (messageColor != DEFAULT_COLOR) {
                ...
                sToast = Toast.makeText(Utils.getContext().getApplicationContext(), spannableString, duration);
            } else {
                sToast = Toast.makeText(Utils.getContext().getApplicationContext(), text, duration);
            }
        }
